...
import com.swpu.DubboMonitor.utils.StringUtils;
...
/**
 * 拦截其中插入的各项方法
 * @see com.swpu.DubboMonitor.transation.ClassTransformer#transform
 */
public class Interceptor { private static ThreadLocal<Trace> data;
